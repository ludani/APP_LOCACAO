<?php
    ...
    if(isset($_GET['codigo_fiador'])) {
      $id = $_GET['codigo_fiador'];
      // select image from db to delete
      $sql= "DELETE FROM fiador WHERE codigo_fiador = $id";
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="form-main-fiador.php">Fiador <span class="glyphicon glyphicon-user" /></a></li> 
    ...
    <div class="col-xs-12 col-md-12 col-sm-12">
      ...
      ?>
        ...
        <div class="col-xs-12 col-md-5 col-sm-5">
            <a class="btn btn-success" href="form-create-fiador.php">Criar Fiador</a>
        </div>
        <div class="col-xs-12 col-md-5 col-sm-5">
        <form method="post">
        ...
        <div class="col-xs-12 col-md-12 col-sm-12">
            ...
            <thead>
                ...
                <tbody>
                  <?php 
                    ...
                    $sql = "SELECT * FROM fiador WHERE nome_fiador LIKE '%$filtro%' ORDER BY codigo_fiador limit $inicio,$registros" ;
                    $resultado = mysqli_query($link, $sql);
                    ...
                    while($registro = mysqli_fetch_array($resultado)) {
                      ...
                      echo '<td width=250>';
                      echo '<a class="btn btn-default" href="form-admin-fiador.php?codigo_fiador='.$id.'">Administrar <span class="glyphicon glyphicon-wrench" /></a>';
                      echo '&nbsp;';
                      ?>

                      <a class="btn btn-danger" href="?codigo_fiador=<?php echo $id ?>" title="Click for Delete" onclick="return confirm('Sure to Delete ?')">Excluir <span class="glyphicon glyphicon-trash" aria-hidden="true"/></a>   
          ...
          <?php
            ...
            if($pagina > 1) {
                ...
                echo "<li><a href='form-main-fiador.php?pagina=".($pagina - 1)."'>&laquo; Anterior</a></li>";
            }
            
            for($i = 1; $i < $numPaginas + 1; $i++) {
                $ativo = ($i == $pagina) ? 'numativo' : '';
                //echo "<a href='form-main-usuario.php?pagina=".$i."' class='numero ".$ativo."'> ".$i." </a>";
                echo "<li><a href='form-main-fiador.php?pagina=".$i."' class='numero ".$ativo."'>".$i."</a></li>";
            }

            if($pagina < $numPaginas) {
                //echo "<a href='form-main-usuario.php?pagina=".($pagina + 1)."' class='controle'>proximo &raquo;</a>";
                echo "<li><a href='form-main-fiador.php?pagina=".($pagina + 1)."'>&raquo; Proximo</a></li>";
            }
