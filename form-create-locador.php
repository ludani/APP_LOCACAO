<?php 
  ...
  if ( !empty($_POST)) {
    ...
    // insert data
    $sql = "INSERT INTO locador (nome_locador, estado_locador, profissao_locador, rg_locador, cpf_locador, hash_locador ) VALUES ('$nome', '$uf', '$profissao', '$rg', '$cpf', '$hash')";
    $resultado = mysqli_query($link, $sql);

    if ($resultado){
      echo "<script>location='form-main-locador.php'</script>";
    } else {
      echo "<script>location='form-create-locador.php'</script>";
    }
  }
?>
<!DOCTYPE html>
...
<nav id="myNavbar" class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="container-fluid">
    <div class="col-xs-6 col-centered">
      ...
      <form class="form" action="form-create-locador.php" method="post">
