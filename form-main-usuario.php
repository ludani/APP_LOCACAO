    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="form-main-usuario.php">Usuário <span class="glyphicon glyphicon-user" /></a></li> 
    ...
    <div class="col-xs-12 col-md-12 col-sm-12">
      ...
      ?>
        ...
        <div class="col-xs-12 col-md-5 col-sm-5">
            <a class="btn btn-success" href="form-create-usuario.php">Criar Usuários</a>
        </div>
        <div class="col-xs-12 col-md-5 col-sm-5">
        <form method="post">
            <strong>Pesquisar ID </strong>
        ...
        <div class="col-xs-12 col-md-12 col-sm-12">
            ...
            <thead>
                ...
                <tbody>
                  <?php 
                    ...
                    $sql = "SELECT * FROM usuario WHERE usu_id LIKE '%$filtro%' ORDER BY usu_id limit $inicio,$registros" ;
                    $resultado = mysqli_query($link, $sql);
                    ...
                    while($registro = mysqli_fetch_array($resultado)) {
                      ...
                      echo '<tr>';
                      echo '<td align="center">'. $usuid . '</td>';
                      echo '<td>'. $nome .'</td>';
                      echo '<td>'. $email .'</td>';
                      echo '<td width=250>';
                      echo '<a class="btn btn-default" href="form-admin-usuario.php?usu_id='.$usuid.'">Administrar <span class="glyphicon glyphicon-wrench" /></a>';
                      echo '&nbsp;';
                      ?>

                      <a class="btn btn-danger" href="?usu_id=<?php echo $usuid ?>" title="Click for Delete" onclick="return confirm('Sure to Delete ?')">Excluir <span class="glyphicon glyphicon-trash" aria-hidden="true"></a>   
          ...
          <?php
            ...
            if($pagina > 1) {
                ...
                echo "<li><a href='form-main-usuario.php?pagina=".($pagina - 1)."'>&laquo; Anterior</a></li>";
            }
            
            for($i = 1; $i < $numPaginas + 1; $i++) {
                $ativo = ($i == $pagina) ? 'numativo' : '';
                //echo "<a href='form-main-usuario.php?pagina=".$i."' class='numero ".$ativo."'> ".$i." </a>";
                echo "<li><a href='form-main-usuario.php?pagina=".$i."' class='numero ".$ativo."'>".$i."</a></li>";
            }

            if($pagina < $numPaginas) {
                //echo "<a href='form-main-usuario.php?pagina=".($pagina + 1)."' class='controle'>proximo &raquo;</a>";
                echo "<li><a href='form-main-usuario.php?pagina=".($pagina + 1)."'>&raquo; Proximo</a></li>";
            }
