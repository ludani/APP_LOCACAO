<?php 
  ...
  if ( !empty($_POST)) {
    ...
    // insert data
    $sql = "INSERT INTO usuario (usu_nome, usu_email, usu_cpf, usu_senha) VALUES ('$nome','$email', '$cpf', md5('$senha'))";
...
<nav id="myNavbar" class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="container-fluid">
    <div class="col-xs-6 col-centered">
      ...
      <form class="form" action="form-create-usuario.php" method="post">
